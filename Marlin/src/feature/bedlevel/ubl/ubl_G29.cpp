...
void unified_bed_leveling::shift_mesh_height() {
  ...
  void unified_bed_leveling::probe_entire_mesh(const xy_pos_t &nearby, const bool do_ubl_mesh_map, const bool stow_probe, const bool do_furthest) {
    ...
    do {
      ...
      best = do_furthest // Points with valid data or HUGE_VALF are skipped // points with valid data and with HUGE_VALF will be skipped
      ...
      if (best.pos.x >= 0) {    // mesh point found and is reachable by probe
        ...
        #endif
        TERN_(PROUI_EX, proUIEx.meshUpdate(best.pos.x, best.pos.y, measured_z));
      }

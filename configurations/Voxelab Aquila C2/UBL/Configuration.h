...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_V427 // Aquila C2 cannot use UBL without bed leveler unless board replaced 
                                          // BOARD_CREALITY_V427 BOARD_VOXELAB_AQUILA BOARD_CREALITY_V4
#endif
